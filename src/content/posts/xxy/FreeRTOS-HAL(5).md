...
## 二、CubeMx配置参数介绍
![每个任务之间隔着个时间片](/img/posts/xxy/5-2.png)
#### Semaphore Name（信号量名称）
仅仅是 CubeMX 图形界面中的标识/标签，方便你区分多个信号量。

#### Max Count（最大计数值）
定义该信号量最多能累加到的上限值。计数值永远不会超过这个数字。
...
仅在 Allocation 选 Static 时有效，用于指定用户定义的控制块变量名。
...
创建计数信号量
![每个任务之间隔着个时间片](/img/posts/xxy/5-3.png)
![每个任务之间隔着个时间片](/img/posts/xxy/5-2.png)
...
配置按键
![每个任务之间隔着个时间片](/img/posts/xxy/5-5.png)
![每个任务之间隔着个时间片](/img/posts/xxy/5-6.png)
创建按键任务
![每个任务之间隔着个时间片](/img/posts/xxy/5-4.png)
...
创建串口发送任务
![每个任务之间隔着个时间片](/img/posts/xxy/5-7.png)
```bash
...
---
## 实验结果
![每个任务之间隔着个时间片](/img/posts/xxy/5-8.png)
